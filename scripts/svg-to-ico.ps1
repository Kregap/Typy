...
foreach ($size in $sizes) {
    inkscape.com -o "icon-$size.png" -w $size -h $size $svg
}
# Combine PNGs into a single ICO file
magick convert icon-16.png icon-32.png icon-48.png icon-64.png icon-128.png icon-256.png src/assets/icon.ico
# Clean up PNGs
